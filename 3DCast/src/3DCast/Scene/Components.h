...
namespace Cast::Component {
	...
	struct CustomMeshComponent : public Component
	{
		...
		void AddToIndexedBatchMemory() {
			memPos = Cast::Memory::BatchMemoryHandler.AddIndexedObject(BatchId, vertexData, vertexDataSize, indexData, indexDataSize);
		}
	};

	struct ObsoleteCustomMeshComponent : public Component
	{
		...
		ObsoleteCustomMeshComponent() = default;
		ObsoleteCustomMeshComponent(const ObsoleteCustomMeshComponent&) = default;
		ObsoleteCustomMeshComponent(int vert_count, size_t stride) {

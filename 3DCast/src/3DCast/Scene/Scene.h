...
namespace Cast
{
 ...
 class Scene
	...
	public:
		...
		void SetActiveShadowDirectionalLight(entt::entity e);
		void ClearActiveShadowDirectionalLight();
		inline entt::entity GetActiveShadowDirectionalLight() const { return ActiveShadowDirLight; }
	...
	protected:
		...
		// Active shadow-casting directional light (unique)
		entt::entity ActiveShadowDirLight{entt::null};

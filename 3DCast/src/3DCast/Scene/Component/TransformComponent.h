...
#pragma region CONSTRUCTOR
		...
		// Delete copy operations - TransformComponent owns a registry entry that cannot be safely shared.
		// EnTT uses move semantics for component relocation, which properly transfers ownership.
